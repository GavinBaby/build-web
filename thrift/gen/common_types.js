...
Back = module.exports.Back = function(args) {
  this.code = null;
  this.text = null;
  this.spare1 = null;
  this.spare2 = null;
...
Page.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.pageSize = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.recordStart = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 4:
      if (ftype == Thrift.Type.STRING) {
        this.sortType = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
