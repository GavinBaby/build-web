...
function FileProgress(file, targetID) {
    ...
    if (!this.fileProgressWrapper.length && !file.isgroup ) {
        console.log(1);
        this.fileProgressWrapper = $('<li/>');
        var Wrappeer = this.fileProgressWrapper;
        Wrappeer.attr('id', this.fileProgressID).addClass('progressContainer');
        Wrappeer.css('width', '200px').css('height', '130px');
        Wrappeer.addClass('alert alert-dismissable');
    ...
    } else if (!this.fileProgressWrapper.length && file.isgroup ) {
        console.log('2');
        this.fileProgressWrapper = $('<li/>');
        var Wrappeer = this.fileProgressWrapper;
        Wrappeer.attr('id', this.fileProgressID).addClass('progressContainer');
        Wrappeer.css('width', '160px').css('height', '130px');
        Wrappeer.addClass('alert alert-dismissable');
        var fileSize = plupload.formatSize(file.size).toUpperCase();
        var progressBarBox = $("<div/>");
        progressBarBox.addClass('info');
        ...
        this.reset();
        this.fileProgressWrapper.css('width', '160px').css('height', '130px');
    }
