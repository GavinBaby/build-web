...
Account.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 7:
      if (ftype == Thrift.Type.STRING) {
        this.regTime = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 8:
      if (ftype == Thrift.Type.STRING) {
        this.regIp = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 9:
      if (ftype == Thrift.Type.STRING) {
        this.thisLoginTime = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 10:
      if (ftype == Thrift.Type.STRING) {
        this.thisLoginIp = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 12:
      if (ftype == Thrift.Type.STRING) {
        this.lastLoginIp = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
AccountList = function(args) {
  this.data = null;
  this.totalSize = null;
  if (args) {
    if (args.data !== undefined && args.data !== null) {
      this.data = Thrift.copyList(args.data, [Account]);
    }
...
MenuList = function(args) {
  ...
  if (args) {
    ...
    if (args.menu !== undefined && args.menu !== null) {
      this.menu = Thrift.copyList(args.menu, [Menu]);
    }
  }
};
MenuList.prototype = {};
