...
BuildDetail.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.main_id = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 5:
      if (ftype == Thrift.Type.STRING) {
        this.url1 = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 6:
      if (ftype == Thrift.Type.STRING) {
        this.url2 = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 7:
      if (ftype == Thrift.Type.STRING) {
        this.url3 = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 8:
      if (ftype == Thrift.Type.STRING) {
        this.url4 = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 9:
      if (ftype == Thrift.Type.STRING) {
        this.url5 = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 10:
      if (ftype == Thrift.Type.STRING) {
        this.url6 = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
Build = function(args) {
  ...
  if (args) {
    ...
    if (args.back !== undefined && args.back !== null) {
      this.back = new Back(args.back);
    }
    if (args.details !== undefined && args.details !== null) {
      this.details = Thrift.copyList(args.details, [BuildDetail]);
    }
  }
};
Build.prototype = {};
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.I32) {
        this.district_id = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 6:
      if (ftype == Thrift.Type.STRING) {
        this.district_name = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
Notice = function(args) {
  ...
  if (args) {
    ...
    if (args.details !== undefined && args.details !== null) {
      this.details = Thrift.copyList(args.details, [NoticeDetail]);
    }
  }
};
Notice.prototype = {};
Notice.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 5:
      if (ftype == Thrift.Type.STRING) {
        this.public_time = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 6:
      if (ftype == Thrift.Type.STRING) {
        this.href_name = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 7:
      if (ftype == Thrift.Type.STRING) {
        this.href = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 9:
      if (ftype == Thrift.Type.STRING) {
        this.start_t = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 10:
      if (ftype == Thrift.Type.STRING) {
        this.end_t = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
Pic = function(args) {
  ...
  if (args) {
    ...
    if (args.details !== undefined && args.details !== null) {
      this.details = Thrift.copyList(args.details, [PicDetail]);
    }
  }
};
Pic.prototype = {};
...
BuildList = function(args) {
  ...
  if (args) {
    if (args.data !== undefined && args.data !== null) {
      this.data = Thrift.copyList(args.data, [Build]);
    }
...
CommentList = function(args) {
  this.data = null;
  this.totalSize = null;
  if (args) {
    if (args.data !== undefined && args.data !== null) {
      this.data = Thrift.copyList(args.data, [Comment]);
    }
    if (args.totalSize !== undefined && args.totalSize !== null) {
      this.totalSize = args.totalSize;
    }
...
NoticeList = function(args) {
  this.data = null;
  this.totalSize = null;
  if (args) {
    if (args.data !== undefined && args.data !== null) {
      this.data = Thrift.copyList(args.data, [Notice]);
    }
    if (args.totalSize !== undefined && args.totalSize !== null) {
      this.totalSize = args.totalSize;
    }
