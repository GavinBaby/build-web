...
AlipayNotify.prototype.verifyNotify = function(_POST, callback){
    ...
    if(Object.keys(_POST).length == 0) {//判断POST来的数组是否为空
    ...
    }else if(_POST['sign_type'] == 'RSA'){
        var pubkey='-----BEGIN PUBLIC KEY-----' + '\r\n' +
            'MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC5xXSjEDdq1L9/E8ttMMW5nc5z'  + '\r\n' +
            'ZGy4ANzSzicGlD6UUvXN2IsKrTVATIuythBe0Mvah8f5tJeKZ5DeW8R12GgU2RTE'  + '\r\n' +
            'JeyMdhYSMhCy0dcqEFeoAmw2C0Tc/auLJeYo6NgYFRzFCGYgCX3/IAaslzbSxexP'  + '\r\n' +
            'RPjVUmf4KFOnUXZnAQIDAQAB'  + '\r\n' +
            '-----END PUBLIC KEY-----';
        //var pubkey=
        //    'MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC5xXSjEDdq1L9/E8ttMMW5nc5z'  + '\n' +
        //    'ZGy4ANzSzicGlD6UUvXN2IsKrTVATIuythBe0Mvah8f5tJeKZ5DeW8R12GgU2RTE'  + '\n' +
        //    'JeyMdhYSMhCy0dcqEFeoAmw2C0Tc/auLJeYo6NgYFRzFCGYgCX3/IAaslzbSxexP'  + '\n' +
        //    'RPjVUmf4KFOnUXZnAQIDAQAB';
         var result = require('alipay-verify').verify(_POST,pubkey);
...
AlipayNotify.prototype.getResponse = function(notify_id, callback){
    ...
    //https://mapi.alipay.com/gateway.do?service=notify_verify&partner=2088801817517336&notify_id=
